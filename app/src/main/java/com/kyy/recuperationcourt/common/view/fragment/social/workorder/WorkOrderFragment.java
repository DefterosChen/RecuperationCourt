 ...
 * DefterosChen
 */
@Page(name = "工单列表", anim = CoreAnim.none)
public class WorkOrderFragment extends MyBaseFragment implements SmartViewHolder.OnItemClickListener {
    ...
    protected void initListeners() {
        ...
        textViewAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openPageForResult(AddWorkOrderFragment.class, null, 100);
        ...
        wadapter.setOnItemClickListener(new SmartViewHolder.OnItemClickListener() {
            ...
            // 待分配、待确认 状态下的操作
            private void showDialogAssign(int position) {

                new AlertDialog.Builder(getContext())
                        .setMessage("工单操作")
                        .setPositiveButton(R.string.kyy_social_sentOrder, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                            ...
                            private void orderSent() {
                                ...
                                AlertDialog dialog = new AlertDialog.Builder(getContext())
                                        .setMessage("请选择分配工单类型")
                                        .setPositiveButton("服务人员", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {

                                                Bundle params = new Bundle();
                                                params.putString(OrderAssignedChoiceFragment.ASSIGNED_TYPE, OrderAssignedChoiceFragment.KEY_ASSIGNED_TYPE_USER);
                                                params.putInt(OrderAssignedChoiceFragment.WORKORDERID, mList.get(position).getId());
                                                openPageForResult(OrderAssignedChoiceFragment.class, params, 100);
                                            }
                                        })
                                        .setNeutralButton("公司", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Bundle params = new Bundle();
                                                params.putString(OrderAssignedChoiceFragment.ASSIGNED_TYPE, OrderAssignedChoiceFragment.KEY_ASSIGNED_TYPE_COMPANY);
                                                openPageForResult(OrderAssignedChoiceFragment.class, params, 100);
                                            }
                                        })
                                        .show();
                        ...
                        .setNeutralButton(R.string.kyy_social_modify, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                            ...
                            private void orderModify() {
                                ...
                                EditText editText = view.findViewById(R.id.tv_input_message);
                                TextView btSumbit = view.findViewById(R.id.tv_input_confirm);
                                TextView btCancel = view.findViewById(R.id.tv_input_cancel);
                                editText.setText(mList.get(position).getOrderDes());
                                ...
                                btSumbit.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    private void updateInfo() {
                                        ...
                                        WorkOrder workOrder = new WorkOrder();
                                        workOrder.setId(mList.get(position).getId());
                                        workOrder.setOrderDes(editText.getText().toString());
                                        ...
                                        String url = ServiceCall.getServerURL() + "/action/workOrder/modify";
                        ...
                        .setNegativeButton(R.string.kyy_social_delete, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                            ...
                            private void orderDelete() {
                                ...
                                WorkOrder workOrder = new WorkOrder();
                                workOrder.setId(mList.get(position).getId());
                                workOrder.setState(OrderState.DELETE.getCode());
