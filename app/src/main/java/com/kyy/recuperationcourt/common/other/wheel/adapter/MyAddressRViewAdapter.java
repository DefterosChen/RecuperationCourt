...
public abstract class MyAddressRViewAdapter<T> extends BaseRecyclerViewAdapter<MyAddressRViewAdapter.ViewHolder> {
    ...
    public MyAddressRViewAdapter(Context context) {
        super(context);
    }
