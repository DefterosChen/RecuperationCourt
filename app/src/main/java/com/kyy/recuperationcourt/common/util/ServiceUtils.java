...
public final class ServiceUtils {
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(DefChenUtil.getContext(), cls);
        DefChenUtil.getContext().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(DefChenUtil.getContext(), cls);
        return DefChenUtil.getContext().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(DefChenUtil.getContext(), cls);
        DefChenUtil.getContext().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        DefChenUtil.getContext().unbindService(conn);
    }
